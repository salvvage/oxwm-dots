...
oxwm.bar.set_scheme_normal(colors.dvio1, "#080711")
oxwm.bar.set_scheme_occupied(colors.dvio3)
oxwm.bar.set_scheme_selected(colors.white,"#3b2e46",colors.white)

oxwm.key.bind({ modkey }, "Return", oxwm.spawn_terminal())
-- oxwm.key.bind({ modkey }, "D", oxwm.spawn({ "sh", "-c", "dmenu_run -l 10" }))
oxwm.key.bind({ modkey }, "D", oxwm.spawn({ "sh", "-c", "rofi -show drun" }))
oxwm.key.bind({ modkey }, "Print", oxwm.spawn({ "sh", "-c", "flameshot gui" }))
