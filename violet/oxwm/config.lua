...
local bar_font = "JetBrainsMono:style=Bold:size=14"
...
oxwm.border.set_focused_color(colors.white)
...
oxwm.bar.set_scheme_normal(colors.vio1, "#3b2e46")
oxwm.bar.set_scheme_occupied(colors.vio3)
oxwm.bar.set_scheme_selected(colors.white,"3bd2e46",colors.white)
...
oxwm.autostart("xwallpaper --zoom ~/Pictures/walls/1.png")
